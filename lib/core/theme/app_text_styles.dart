...
class AppTextStyles {
  static const TextStyle _base = TextStyle(fontFamily: 'SF Pro Display');
  ...
  static TextStyle get h4 =>
      _base.copyWith(fontSize: 20, fontWeight: FontWeight.w600, height: 1.25);

  // Body
  static TextStyle get bodyLarge =>
      _base.copyWith(fontSize: 17, fontWeight: FontWeight.w400, height: 1.45);
  ...
  static TextStyle get labelLarge =>
      _base.copyWith(fontSize: 14, fontWeight: FontWeight.w700, height: 1.4);

  static TextStyle get labelMedium =>
      _base.copyWith(fontSize: 12, fontWeight: FontWeight.w600, height: 1.4);
  ...
  static TextStyle get receiptBody =>
