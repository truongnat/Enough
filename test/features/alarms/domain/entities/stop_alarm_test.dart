...
void main() {
  group('StopAlarm - Next Alarm Calculation', () {
    test('should return today if alarm time is in the future and no repeat days', () {
    ...
    test('should return tomorrow if alarm time has passed today and no repeat days', () {
    ...
    test('should return next week if today is the repeat day but time has passed', () {
      // Monday (weekday 1)
